...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-150823327-2"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-150823327-2');
    </script>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth('web_admin')
                            <li class="nav-item">
                                <a href="{{ route('quotes.create') }}" class="nav-link">Add</a>
                            </li>
                        @endauth
                    </ul>
